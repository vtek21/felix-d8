...
function hook_felix_block_config($block) {
  return \Drupal::moduleHandler()->invoke($block->module, 'block_configure', [$block->delta]);
}
...
function hook_felix_block_config_save($block, $values) {
  return \Drupal::moduleHandler()->invoke($block->module, 'block_save', [$block->delta, $values]);
}
